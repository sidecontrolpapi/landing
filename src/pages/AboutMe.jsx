...
const AboutMe = ()=> {
    ...
    return (
        <section id="AboutMe">
            ...
            <div id="summary">
                <h1 className={`red ${selected>=1 && selected<3?"typed":"beforeType"}`}>&#47;&#47;About Me</h1>
                <p className={`${selected>=1 && selected<3?"textShowing":"beforeShow"}`}>
